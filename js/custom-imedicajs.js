...
=============================================== */
    ...
    var useGrouping = true;
        ...
        var demo = new countUp('myTargetElement', 0, 100, 0, 5, options);
        demo.start();
      });
  ...
  $(document).ready(function(){
        $('.counter-style').appear(function(){
        var demo = new countUp('myTargetElement2', 0, 300, 0, 5, options);
        demo.start();
      });
  ...
  $(document).ready(function(){
        $('.counter-style').appear(function(){
        var demo = new countUp('myTargetElement3', 0, 5000, 0, 5, options);
        demo.start();
      });
